...
<strong>User init param value</strong>:<%=config.getInitParameter("dname") %><br><br>
 
<%-- application object example --%>
<strong>User context param value</strong>:<%=application.getInitParameter("contextConfigLocation") %><br><br>
